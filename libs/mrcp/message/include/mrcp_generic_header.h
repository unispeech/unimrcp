...
/** Max number of vendor specific parameter pairs in list */
#define MAX_VENDOR_SPECIFIC_PARAMS_COUNT 10
/** List (array) of MRCP vendor specific parameter pairs */
struct mrcp_vendor_specific_params_list_t {
	/** Array of vendor specific parameter pairs */
	apt_str_t pairs[MAX_VENDOR_SPECIFIC_PARAMS_COUNT];
	/** Number of vendor specific parameter pairs */
	size_t    count;
};
